...
// ==========================================================
// File: TCDev.Utilities.Cryptography.cs
// Created: 15.04.2021
// Created By: Tim cadenbach
// 
// Copyright (C) 2020 TCDev GmbH
...
namespace TCDev.Utilities.Cryptography
{
   public static class Crypto
   {
      ...
      public static string EncryptStringAES(this string plainText, string sharedSecret, byte[] _salt)
      {
      ...
      public static string DecryptStringAES(this string cipherText, string sharedSecret, byte[] _salt)
      {
