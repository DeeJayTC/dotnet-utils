...
namespace TCDev.Utilities.DateAndTime.BankHolidays
{
    public class GermanyProvider : IPublicHolidayProvider, ICountyProvider
    {
        ...
        public IEnumerable<PublicHoliday> Get(int year)
        {
            ...
            {
                new PublicHoliday(year, 1, 1, "Neujahr", "New Year's Day", countryCode, 1967),
                new PublicHoliday(year, 1, 6, "Heilige Drei Könige", "Epiphany", countryCode, 1967, new string[] { "DE-BW", "DE-BY", "DE-ST" }),
                new PublicHoliday(year, 3, 8, "Internationaler Frauentag", "International Women's Day", countryCode, 2019, new string[] { "DE-BE" }),
                new PublicHoliday(easterSunday.AddDays(-2), "Karfreitag", "Good Friday", countryCode),
                new PublicHoliday(easterSunday.AddDays(1), "Ostermontag", "Easter Monday", countryCode, 1642),
                new PublicHoliday(year, 5, 1, "Tag der Arbeit", "Labour Day", countryCode),
                new PublicHoliday(easterSunday.AddDays(39), "Christi Himmelfahrt", "Ascension Day", countryCode),
                new PublicHoliday(easterSunday.AddDays(50), "Pfingstmontag", "Whit Monday", countryCode),
                new PublicHoliday(easterSunday.AddDays(60), "Fronleichnam", "Corpus Christi", countryCode, null, new string[] { "DE-BW", "DE-BY", "DE-HE", "DE-NW", "DE-RP", "DE-SL" }),
                new PublicHoliday(year, 8, 15, "Mariä Himmelfahrt", "Assumption Day", countryCode, null, new string[] { "DE-SL" }),
                new PublicHoliday(year, 9, 20, "Weltkindertag", "World Children's Day", countryCode, 2019, new string[] { "DE-TH" }),
                new PublicHoliday(year, 10, 3, "Tag der Deutschen Einheit", "German Unity Day", countryCode),
                new PublicHoliday(year, 11, 1, "Allerheiligen", "All Saints' Day", countryCode, null, new string[] { "DE-BW", "DE-BY", "DE-NW", "DE-RP", "DE-SL" }),
                new PublicHoliday(year, 12, 25, "Erster Weihnachtstag", "Christmas Day", countryCode),
                new PublicHoliday(year, 12, 26, "Zweiter Weihnachtstag", "St. Stephen's Day", countryCode)
            };
